            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal" action="{{route('admin.panitia.store')}}" method="POST">
                            @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control text-uppercase {{ $errors->has('alamat') ? 'is-invalid' : '' }}" id="alamat" placeholder="alamat" name="alamat" required>
