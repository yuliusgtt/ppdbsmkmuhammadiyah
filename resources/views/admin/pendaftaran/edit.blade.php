...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <form class="col-12" action="{{route('admin.pendaftaran.update',[$Data->nomor_pendaftaran])}}" method="post" enctype="multipart/form-data">
                @csrf
                {{ method_field('PUT') }}
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <select class="form-control select2" id="status" name="id_status_calon_siswa" required>
                                            @foreach($Status as $status)
                                                <option value="{{$status->id}}" <?php if ($Data->id_status_calon_siswa == $status->id){echo 'selected';} ?>>{{$status->status}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="email" class="form-control text-uppercase" id="email" value="{{$Data->user->email}}" name="email" required autocomplete="off">
                                </div>
                ...
                <div class="row">
                    <div class="card-body">
                        <button type="submit" class="btn btn-block btn-warning"><i class="fa fa-edit"></i>Edit Data</button>
                    </div>
                </div>
            </form>
        </div>
